		...
		{{^SHOW_RESTORE}}
			<td class="basket-items-list-item-descriptions">
				<div class="row">
					...
					{?>
						<div class="basket-items-list-item-descriptions-inner col-3 col-sm-2">
					...
					<?}?>
					<div class="basket-items-list-item-descriptions-inner col-9 col-sm-5">
					...
					<div class="basket-items-list-item-descriptions-inner col-sm">
						<div class="basket-item-block-info">
							{{#WARNINGS.length}}
								<div class="basket-items-list-item-warning-container">
			...
			?>
			<td class="basket-items-list-item-amount" style="min-width: 200px;">
				<div class="basket-item-block-amount{{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}}" data-entity="basket-item-quantity-block">
					<span class="basket-item-amount-btn-minus d-none" data-entity="basket-item-quantity-minus"></span>
					<div class="basket-item-amount-filed-block">
						<input type="text" class="basket-item-amount-filed" value="{{QUANTITY}}"
							{{#NOT_AVAILABLE}} disabled="disabled"{{/NOT_AVAILABLE}}
							data-value="{{QUANTITY}}" data-entity="basket-item-quantity-field"
							id="basket-item-quantity-{{ID}}">
						<div id="basket-item-progress-{{ID}}" class="progress" data-toggle="tooltip" data-placement="auto" title="" data-original-title="Доступность выполнения 100%">
							<div id="basket-item-progress-bar-{{ID}}" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%"></div>
						</div>
						<div id="basket-item-settings-{{ID}}" class="d-inline pull-right cursor-pointer" style="position: absolute;left: 100%;top: 2px;margin-left: 2px;">
							<div id="basket-item-analog-{{ID}}" data-toggle="tooltip" data-placement="auto" title="" class="d-none text-danger" data-original-title="Имеются аналоги"><i class="fas fa-funnel-dollar"></i></div>
							<div id="basket-item-wait-{{ID}}" data-toggle="tooltip" data-placement="auto" title="" class="d-none text-danger" data-original-title="Загрузить с РЦ (+7 дней)"><i class="far fa-clock"></i></div>
							<div id="basket-item-alert-{{ID}}" data-toggle="tooltip" data-placement="auto" title="" class="d-none text-info" data-original-title="Внманик!"><i class="fas fa-exclamation-triangle"></i></div>
							<div id="basket-item-done-{{ID}}" data-toggle="tooltip" data-placement="auto" title="" class="d-none text-info" data-original-title="Выполнено"><i class="fas fa-check-circle"></i></div>
							<div id="basket-item-info-{{ID}}" data-toggle="tooltip" data-placement="auto" title="" class="d-none text-info" data-original-title="Инофрмация"><i class="fas fa-info-circle"></i></div>
						</div>
					</div>
					<span class="basket-item-amount-btn-plus d-none" data-entity="basket-item-quantity-plus"></span>
			...
			if ($useActionColumn)
			{
				...
				<td class="basket-items-list-item-remove d-none d-md-block">
					<div class="basket-item-block-actions">
						<span class="basket-item-actions-remove" data-entity="basket-item-delete" title="<?=Loc::getMessage('SBB_DELETE')?>"></span>
						{{#SHOW_LOADING}}
							<div class="basket-items-list-item-overlay"></div>
						{{/SHOW_LOADING}}
					</div>
