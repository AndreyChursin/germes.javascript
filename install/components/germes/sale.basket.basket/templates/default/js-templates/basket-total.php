...
<script id="basket-total-template" type="text/html">
	<div class="basket-checkout-container mb-3" data-entity="basket-checkout-aligner">
		<?
		...
		<div class="basket-checkout-section">
			<div class="basket-checkout-section-inner<?=(($arParams['HIDE_COUPON'] == 'Y') ? ' justify-content-between' : '')?>">
				...
				<div class="basket-checkout-block basket-checkout-block-btn">
					<button class="btn btn-sm small basket-btn-clear{{#DISABLE_CHECKOUT}} disabled{{/DISABLE_CHECKOUT}}"
						data-entity="basket-clear-button">
						<?=Loc::getMessage('SBB_ORDER_CLEAR')?>
					</button>
