...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		init: function(parameters)
		{
			...
			if (this.params.hide_physische_person_block === 'Y')
			{
		...
		getDeliveryLocationInput: function(node)
		{
			...
			if (location && location[0] && location[0].output)
			{
				...
				insertedLoc = BX.create('DIV', {
					...
					props: {className: 'form-group bx-soa-location-input-container'+(this.params.hide_physische_person_block=="Y"?' d-none':'')},
		...
		getZipLocationInput: function(node)
		{
			...
			if (zipProperty)
			{
				...
				propsItemNode = BX.create('DIV', {props: {className: "form-group bx-soa-location-input-container"+(this.params.hide_physische_person_block=="Y"?' d-none':'')}});
		...
		editPropsItems: function(propsNode)
		{
			...
			var propsItemsContainer = BX.create('DIV', {props: {className: 'col-sm-12 bx-soa-customer'+(this.params.hide_physische_person_block=="Y"?' d-none':'')}}),
